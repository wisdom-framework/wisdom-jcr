 ...
 */
@Service(RestNodeHandler.class)
public final class RestNodeHandlerImpl extends ItemHandlerImpl implements RestNodeHandler {
     ...
     */
    @Override
    public RestItem updateNodeWithId(Request request,
    ...
    private JsonNode stringToJSONObject(String requestBody) {
        return StringUtil.isBlank(requestBody) ? json.newObject() : json.parse(requestBody);
    }
     ...
     */
    @Override
    public void deleteNodeWithId(Request request,
                                 String rawRepositoryName,
                                 String rawWorkspaceName,

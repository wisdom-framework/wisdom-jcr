...
import static org.modeshape.web.jcr.rest.RestHelper.*;
...
public abstract class AbstractHandler {
    ...
    protected RestItem createRestItem(Request request,
                                      int depth,
                                      Session session,
    ...
    protected Result exceptionResponse(String message) {
        return new Result(400).render(new RestException(message));
    }
}

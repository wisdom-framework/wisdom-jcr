...
public final class FileUploadForm {
     ...
     * @return an {@link java.io.InputStream} instance, or {@code null}
     */
    ...
    /**
     * Sets the {@link java.io.InputStream} which corresponds to the HTML element named {@code file}. RestEASY will call this method.
     *
     * @param fileData a {@link java.io.InputStream} or {@code null} if there isn't an HTML field with the {@code file} name.
     */

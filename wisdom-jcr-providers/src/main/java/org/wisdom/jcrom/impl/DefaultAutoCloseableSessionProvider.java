...
@Component
@Provides(specifications = AutoCloseableSessionProvider.class)
@Instantiate
public class DefaultAutoCloseableSessionProvider implements AutoCloseableSessionProvider {

    @Override
    public AutoCloseableSession createAutoCloseableSession(Session session) {
